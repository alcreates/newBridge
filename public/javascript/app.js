...
for (var i = 0; i < languages.length; i++) {
    $("#dropdown1").append("<button style='display:block; width:100%;' class='answer-button1 red darken-4 ' id='button' value=" + languages[i].value + " data-name=" + languages[i].language + "''>" + languages[i].language + "</button>");
}
