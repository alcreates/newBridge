...
function display(){
  ...
  $("#resultDiv").empty();
	...
	$("#questionDiv").html("<h4>" + questions[questionNumber].question + "</h4>");
      ...
      $("#panel").append("<a  style='display:block;width:100%'class='answer-button waves-effect waves-light btn-large' id='button'" + "data-name='" + questions[this.questionNumber].answers[i] + "''>" + questions[this.questionNumber].answers[i]+ "</a>");
